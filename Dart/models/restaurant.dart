...
class Restaurant {
  ...
  factory Restaurant.fromJson(Map<String, dynamic> json) => new Restaurant(
    ...
    rating: json["rating"] == null ? null : Converter.dynamicToDouble(json["rating"]),
...
class Coordinates {
  ...
  factory Coordinates.fromJson(Map<String, dynamic> json) => new Coordinates(
    latitude: json["latitude"] == null ? null : Converter.dynamicToDouble(json["latitude"]),
    longitude: json["longitude"] == null ? null : Converter.dynamicToDouble(json["longitude"]),
  );
